def matrix_multiply(a, b):
    ...
    Returns:
        list of lists: Resulting 2x2 matrix after multiplication
    """
    return [
...
def matrix_power(matrix, n):
    ...
    Returns:
        list of lists: Matrix raised to power n
    """
    # Base cases
    if n == 0:
...
def fibonacci(n):
    """
    Compute the n-th Fibonacci number with O(log n) time complexity.
    ...
    # Base matrix for Fibonacci computation
    base_matrix = [[1, 1], [1, 0]]
    
    # Compute matrix power
    result_matrix = matrix_power(base_matrix, n - 1)
    
    # Return the top-left element which represents F(n)
